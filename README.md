...
> **[SUPPLEMENTARY_MATERIAL (SM.pdf)](SM.pdf)**: Supplementary methods, analyses, and supporting documentation for the study.


The repository includes:
- [Bluesky_Data](Bluesky_Data): sample Bluesky data, microtopics, and theme-generation outputs. The full 38.5 million-post Bluesky dataset may be available for research use upon reasonable request.
- [EO_Data](EO_Data): executive-order theme-generation outputs
- [Code_Scripts](Code_Scripts): retained collection, sentiment, structural-break, and figure-generation scripts
...
The full post-level Bluesky dataset of 38,467,701 posts is not stored in this repository. Researchers may request access for research use. If you use the full dataset, please cite the main paper listed below in addition to any workflow-specific citations.
...
- executive-order and Bluesky figure generation
...
Most analysis scripts still require local research data referenced through placeholder paths such as `local_data/...`.
...
If you found this repository helpful, please cite the main paper:
...
Additionally, please consider cite  the microtopics workflow: 
...
```bibtex
@misc{salloum2025politics,
      title={Politics and polarization on Bluesky}, 
      author={Ali Salloum and Dorian Quelle and Letizia Iannucci and Alexandre Bovet and Mikko Kivelä},
      year={2025},
      eprint={2506.03443},
      archivePrefix={arXiv},
      primaryClass={cs.SI},
      url={https://arxiv.org/abs/2506.03443}, 
}
```

And Theme-generation workflow:
