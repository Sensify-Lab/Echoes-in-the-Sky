...
SOURCE_TABLE_DIR = Path("local_data/bluesky_sentiment/theme_sentiment_changes/tables")
BASE_DIR = Path("local_data/bluesky_sentiment/monthly_text_sentiment_overview_per_theme")
